 ...
 * Solution:
  ...
  Use a union-find data structure with each site representing a social network member. Add unions between sites in time order of friendships being formed.
  After each union is added, check the number of connected components within the union-find data structure. If only one, all members are connected.
 
  Must keep track of number of unique components. Decreases when a union occurs between different components.
 */
"""
